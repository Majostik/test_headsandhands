...
import com.example.majo.test_hah.R
import com.example.majo.test_hah.base.AbstractBaseActivity
...
class MainActivity : AbstractBaseActivity<MainView, MainPresenter>(), MainView {
    ...
    private fun isInputValid(): Boolean{
        ...
        if (password.isEmpty()){
            ...
            isValid = false
            mainPasswordTil.error = getString(R.string.error_password_lenght)
